# Phenesthe (Mathisis)
---
Mathisis branch of Phenesthe offers a prototype for learning dynamic temporal phenomena definitions (repo docs in progress). 

To run learning experiments, navigate to samples/maritime download the dataset and run the commands included in the readme included in the same folder.
