assert_input_phenomena(5):-
    ...
    assert(input_event_instant(stares(bob,alice),1)),
    assert(input_event_instant(stares(alice,bob),1)),
    ...
    assert(input_event_instant(stares(bob,alice),5)),
    assert(input_state_interval(angry(alice),[1,2])).
assert_input_phenomena(10):-
    assert(input_event_instant(stares(alice,bob),6)),
    ...
    assert(input_event_instant(stares(bob,alice),9)),
    assert(input_event_instant(pickup(john,wallet),10)),
    assert(input_event_instant(stares(alice,bob),10)).
